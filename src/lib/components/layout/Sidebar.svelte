...
>
	...
	>
		...
		<div class="px-2 flex justify-center mt-0.5">
			...
			target="_blank"
			title="Tipps für präzise Prompteingabe">
				<div class="self-center">
					<svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor" class="w-4 h-4">
						<path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M3 3h18v18H3V3zm3 16l3-3 3 3 3-3 3 3"></path>
					</svg>
				...
				<div class="flex self-center">
					<div class="self-center font-medium text-sm">Prompt-Tipps</div>
				</div>
			</a>
		</div>
		...
		<div class="px-2 flex justify-center mt-0.5">
			<a
			class="flex-grow flex space-x-3 rounded-xl px-3.5 py-2 hover:bg-gray-200 dark:hover:bg-gray-900 transition"
			href="https://fimrc.sharepoint.com/sites/IT-Services/Apps/SitePages/FimAI.aspx"
			target="_blank"
			title="Bedienungsanleitung und allgemeine Informationen">
				<div class="self-center">
					<svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor" class="w-4 h-4">
						<path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M3 3h18v18H3V3zm3 16l3-3 3 3 3-3 3 3"></path>
					</svg>
				...
				<div class="flex self-center">
					<div class="self-center font-medium text-sm">Anleitung</div>
				</div>
			</a>
		</div>
